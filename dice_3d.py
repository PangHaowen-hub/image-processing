...
def dice_3d(mask_path, pred_path):
    ...
    mask_img_arr[mask_img_arr == 2] = 1
    pred_img_arr[pred_img_arr != 2] = 0
    pred_img_arr[pred_img_arr == 2] = 1
...
if __name__ == '__main__':
    mask_path = r'F:\my_lobe_data\after\RL\test_mask'
    # pred_path = r'F:\my_lobe_data\after\RL\test_mask'
    pred_path = r'F:\my_lobe_data\after\RL\add_left_right'
