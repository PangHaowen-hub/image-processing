...
def pad(img_path, save_path):
    ...
    pad_transform = tio.transforms.CropOrPad((384, 256, 256), padding_mode=-1024)  # TODO:修改Padding值
...
if __name__ == '__main__':
    img_path = r'G:\lobe_registration\LL\before\warped_resample'
    save_path = r'G:\lobe_registration\LL\before\warped_resample_pad'
