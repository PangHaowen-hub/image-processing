...
def read(Filelist_CT, Filelist_mask):
    ...
    mask_img_arr = ct_img_arr * np.where(mask_img_arr ==2, 1, 0)
    ...
    n, bins, patches = plt.hist(arr, density=True, bins=18, range=[-1000, -100])
    # print(n)
...
if __name__ == '__main__':
    path_CT = r'E:/2D/DICOM/'
    path_mask =r'E:/2D/niimask/'
