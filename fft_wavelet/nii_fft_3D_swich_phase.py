...
if __name__ == '__main__':
    ...
    for i in trange(len(ct_list)):
        ...
        fimg_rec_CT.real = fimg_CT_fre * np.cos(fimg_MRI_pha)
        fimg_rec_CT.imag = fimg_CT_fre * np.sin(fimg_MRI_pha)
        ...
        fimg_rec_MRI.real = fimg_MRI_fre * np.cos(fimg_CT_pha)
        fimg_rec_MRI.imag = fimg_MRI_fre * np.sin(fimg_CT_pha)
