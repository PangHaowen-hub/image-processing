...
def get_all_file(path):
    ...
    try:
        ...
        allfile = os.path.join(path, filelist, allfilelist[1])
        dcm = os.listdir(allfile)[0]
        dcm_path = os.path.join(path, filelist, allfilelist[1], dcm)
        return dcm_path
    except:
        return dcm_path
...
if __name__ == '__main__':
    ...
    workbook.save(r'G:\gz_data\double_gas\data_486_1.xls')  # 保存
